...
public static class Bezier
{
    ...
    public static Vector2 CubicBezierInterp(Transform p1, Transform p2, Transform p3, Transform p4,
        float t)
    {
        Vector2 a = LineLerp(p1.position, p2.position, t);
        Vector2 b = LineLerp(p2.position, p3.position, t);
    ...
    public static Vector2 NOrderBezierInterp(List<Transform> points, float t)
    {
        if (points.Count < 2)
            throw new System.Exception(
                "Bezier Curve needs atleast 3 points, or 2 for a linear interpolation");
